$(document).ready(function()
{
    ...
    $("#UnfuddleTicketsDiv tr td:nth-child(4)").css("text-align", "right");
    $("#UnfuddleTicketsDiv tr td:nth-child(4)").css("font-style", "italic");
    $("#UnfuddleTicketsDiv tr td:nth-child(5)").css("display", "none");
    $("#UnfuddleTicketsDiv tr td:nth-child(3)").css("display", "none");
